...
//    @Override
    ...
    public List<Listing> findAllListings() {
        String sql = "SELECT l.listing_id, l.seller_id, l.category_id, l.size_id, l.item_type, l.model, l.brand, l.description, l.conditions, " +
                "l.materials, l.price, l.max_discount_percent, l.created_at,l.status, l.is_fair_trade, l.is_validated, l.color, s.size_label " +
